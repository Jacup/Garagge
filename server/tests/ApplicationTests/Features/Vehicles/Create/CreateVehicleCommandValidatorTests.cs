...
namespace ApplicationTests.Features.Vehicles.Create;
...
public class CreateVehicleCommandValidatorTests
{
    ...
    public CreateVehicleCommandValidatorTests()
    {
        ...
        _validator = new CreateVehicleCommandValidator(_dateTimeProvider.Object, compatibilityService);
    }
    ...
    public void Validate_WhenEnergyTypesExceedsMaximumCount_ShouldHaveError()
    {
        var energyTypes = new[]
        {
            EnergyType.Gasoline, EnergyType.Diesel, EnergyType.LPG, EnergyType.CNG, EnergyType.Ethanol, EnergyType.Biofuel, EnergyType.Electric,
            EnergyType.Hydrogen, EnergyType.Gasoline
        };
        var command = new CreateVehicleCommand("Audi", "A4", EngineType.Fuel, EnergyTypes: energyTypes);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(c => c.EnergyTypes);
    ...
    public void Validate_WhenCommandWithValidEnergyTypes_ShouldNotHaveError()
    {
        ...
        var command = new CreateVehicleCommand("Audi", "A4", EngineType.Fuel, energyTypes, 2010, VehicleType.Car, "1HGBH41JXMN109186");
        var result = _validator.TestValidate(command);
        result.IsValid.ShouldBeTrue();
    }
