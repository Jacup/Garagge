...
<template>
  <v-container fluid class="pa-6">
    <!-- Header -->
    <div class="mb-6">
      <h1 class="text-h3 font-weight-light mb-2">Dashboard</h1>
      <p class="text-body-1 text-medium-emphasis">Welcome back! Here's what's happening with your fleet.</p>
    </div>
        ...
        <v-card elevation="2" class="feature-card">
          <v-card-text class="text-center pa-8">
            ...
            <p class="text-body-2 text-medium-emphasis mb-4">
              Keep track of upcoming maintenance and services
            </p>
      ...
      <v-col cols="12" md="4">
        <v-card elevation="2" class="feature-card">
          <v-card-text class="text-center pa-8">
            ...
            <p class="text-body-2 text-medium-emphasis mb-4">
              Monitor your routes and optimize fuel consumption
            </p>
      ...
      <v-col cols="12" md="4">
        <v-card elevation="2" class="feature-card">
          <v-card-text class="text-center pa-8">
            ...
            <p class="text-body-2 text-medium-emphasis mb-4">
              Analyze expenses and optimize your fleet budget
            </p>
