...
const getApiUsersUserId = (
  ...
  const putApiUsersMeChangePassword = (
    changePasswordRequest: ChangePasswordRequest,
 ) => {
      return axiosInstance<unknown>(
      {url: `/api/users/me/change-password`, method: 'PUT',
  ...
  return {getApiUsersUserId,putApiUsersMeChangePassword,deleteApiUsersMe,getApiUsersMe,putApiUsersMe,deleteApiUsersMeSessions,getApiUsersMeSessions,deleteApiUsersMeSessionsId}};
export type GetApiUsersUserIdResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getUsers>['getApiUsersUserId']>>>
export type PutApiUsersMeChangePasswordResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getUsers>['putApiUsersMeChangePassword']>>>
