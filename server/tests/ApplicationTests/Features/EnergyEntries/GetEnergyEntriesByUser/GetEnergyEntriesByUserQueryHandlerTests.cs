...
namespace ApplicationTests.Features.EnergyEntries.GetEnergyEntriesByUser;
...
public class GetEnergyEntriesByUserQueryHandlerTests : InMemoryDbTestBase
{
    ...
    public async Task Handle_UserTriesToAccessOtherUsersEntries_ReturnsNotFoundError()
    {
        ...
        var query = new GetEnergyEntriesByUserQuery(otherUserId, 1, 20);
    ...
    public async Task Handle_UserHasEnergyEntries_ReturnsPagedListWithEntries()
    {
        ...
        result.Value.Items[0].Id.ShouldBe(energyEntry1.Id);
    ...
    public async Task Handle_EntriesSortedByDateAndMileage_ReturnsCorrectOrder()
    {
        ...
        result.Value.Items[0].Id.ShouldBe(entry3.Id);
        result.Value.Items[1].Id.ShouldBe(entry2.Id);
        result.Value.Items[2].Id.ShouldBe(entry1.Id);
    }
