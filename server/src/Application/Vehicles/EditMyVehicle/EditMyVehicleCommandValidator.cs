...
internal sealed class EditMyVehicleCommandValidator : AbstractValidator<EditMyVehicleCommand>
{
    public EditMyVehicleCommandValidator(IDateTimeProvider dateTimeProvider)
    {
