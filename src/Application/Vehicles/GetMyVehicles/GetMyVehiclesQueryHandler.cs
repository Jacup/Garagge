...
internal sealed class GetMyVehiclesQueryHandler(IApplicationDbContext context, IUserContext userContext) : IQueryHandler<GetMyVehicles, ICollection<VehicleDto>>
{
    public async Task<Result<ICollection<VehicleDto>>> Handle(GetMyVehicles request, CancellationToken cancellationToken)
    {
